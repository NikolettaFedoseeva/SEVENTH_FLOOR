...
export function useCreateProperty(propertyId?: string) {
  ...
  const validate = (rubric?: string) => {
    ...
    const needsRooms = ["apartment", "house", "room"].includes(
      form.type as string,
    );
    ...
    if (rubric !== "exchange") {
      ...
      if (currentType === "apartment" || currentType === "room") {
        ...
        if (!form.totalFloors) {
          errors.totalFloors = "Укажите этажность дома";
          isValid = false;
        }
        if (!form.bathroom) {
          errors.bathroom = "Укажите тип санузла";
          isValid = false;
        }
        if (!form.balcony) {
          errors.balcony = "Укажите наличие балкона";
          isValid = false;
        }
        if (!form.parking) {
          errors.parking = "Укажите тип парковки";
          isValid = false;
        }
        if (!form.constructionType) {
          errors.constructionType = "Укажите тип строения";
          isValid = false;
        }
        if (!form.condition) {
          errors.condition = "Укажите состояние квартиры";
          isValid = false;
        }
        if (!form.heating) {
          errors.heating = "Укажите тип отопления";
          isValid = false;
        }
        ...
        if (!form.condition) {
          errors.condition = "Укажите состояние дома";
          isValid = false;
        }
        if (!form.bathroom) {
          errors.bathroom = "Укажите тип санузла";
