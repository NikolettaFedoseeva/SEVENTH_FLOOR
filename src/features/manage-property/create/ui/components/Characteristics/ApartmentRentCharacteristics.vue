...
<template>
  ...
  <div class="field small">
    ...
    <Dropdown v-model="form.roomType" :options="roomTypesList" />
  </div>
  <div class="field small">
  ...
  <div class="field small">
    ...
    <Dropdown v-model="form.buildingType" :options="buildingTypes" />
  </div>
  <div class="field small">
  ...
  <div class="field small">
    ...
    <Dropdown v-model="form.apartmentSeries" :options="apartmentSeries" />
  </div>
  <div class="field">
